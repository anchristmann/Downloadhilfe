Moin.
Diese Downloadhilfe lädt beliebige Bücher von "elibrary.utb.de" automatisch herunter und umgeht so das lästige anklicken jedes einzelnen Unterkapitels.
...
Damit das Programm funktioniert, müssen Sie lediglich den erhaltenen .zip-Ordner in ihren Speicherort für EBooks entpacken.
	-> Höchstwahrscheinlich haben Sie das Programm per Mail bekommen. Klicken Sie einfach doppelt auf den Anhang und wählen Sie "Öffnen mit:" aus.
	-> In dem geöffneten .zip Ordner wählen Sie den Ordner "Downloadhilfe" einfach aus und drücken "Strg+X". Gehen Sie nun in ihren Speicherort
		und drücken Sie "Strg+V". Es sollte nun ein neuer Ordner mit dem Namen "Downloadhilfe erschienen sein.
--------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------
