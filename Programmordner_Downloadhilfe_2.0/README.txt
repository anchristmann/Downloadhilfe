Moin.
Diese Downloadhilfe lädt beliebige Bücher von "elibrary.utb.de" und "beck-elibrary.de" automatisch herunter und umgeht so das lästige Anklicken jedes
einzelnen Unterkapitels.

INHALTSVERZEICHNIS:
--------------------------------------------------------------------------------------------------------------------------------------------------------
1. Installation
2. Benutzungshinweise
3. Hinweise zum Compilieren und erstellen der .exe
4. Source-Code
--------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
DISCLAIMER
Das Programm "Downloadhilfe.exe" wird beim Starten als unbekanntes Programm von Windows blockiert. Der Grund dafür liegt in der Natur der Sache.
Die Downloadhilfe ist ein studentisches Hilfstool, was so benutzerfreundlich wie möglich ausgeliefert werden soll. Windows sträubt sich aber unsignierte
Dateien zu öffnen. 
Es bleibt jedem selber überlassen, ob er die Downloadhilfe benutzen möchte. Weiter unten wird der Code des Programms offengelegt, damit jeder eine
Entscheidungsgrundlage hat, ob er die fertige .exe benutzen möchte oder ein Pythonscript mit dem Code füllt.
________________________________________________________________________________________________________________________________________________________
________________________________________________________________________________________________________________________________________________________

Damit das Programm funktioniert, müssen Sie lediglich den erhaltenen .zip-Ordner in ihren Speicherort für EBooks entpacken.
	-> Höchstwahrscheinlich haben Sie das Programm per Mail bekommen. Klicken Sie auf den Anhang und wählen Sie "Datei speichern" aus.
	-> Wählen Sie den Speicherort Ihrer EBooks aus und speichern Sie die .zip
	-> Entpacken Sie die .zip in einen Ordner Ihrer Wahl
	-> Sie können das Programm jetzt nutzen
--------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
BENUTZUNGSHINWEISE:
--------------------------------------------------------------------------------------------------------------------------------------------------------
Das Programm wird über Tastatureingaben gesteuert. Alle validen Angaben sind noch einmal in runden Klammern angegeben.
Wenn das Programm nach einer Benutzereingabe fragt, geben Sie Ihre Antwort ein und bestätigen mit ENTER.

	BEISPIEL:
	Sie werden für den Download gefragt, unter welchem Namen das Buch gespeichert werden soll. Im Programm sieht die Frage so aus:
		"Unter welchem Namen soll das Buch gespeichert werden? Hier eingeben:" [HIER IHRE ANTWORT EINGEBEN]
	Sie geben nun einfach den gewünschten Namen der PDF ein und drücken ENTER.

Hoffentlich konnte ich alle auftretenden Fragen beantworten.
--------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------



HINWEISE ZUM COMPILIEREN UND ERSTELLEN DER .EXE:
--------------------------------------------------------------------------------------------------------------------------------------------------------
Zum Compilieren der Version 2.0 wurde Python 3.8 benutzt mit den Libraries: request, bs4, PyPDF2.
Zum Erstellen der .exe wurde PyInstaller genutzt mit dem folgenden in "Programmordner_Downlaodhilfe_2.0" ausgeführten Befehl:
	pfad_zu_python_mit_installierten_requirements_und_pyinstaller\python.exe -m PyInstaller -F --icon=lib\icon.ico main.py
--------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------
